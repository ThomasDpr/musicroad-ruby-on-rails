...
ActiveRecord::Schema[7.0].define(version: 2023_06_05_124149) do
  ...
  create_table "chatrooms", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["city_id"], name: "index_chatrooms_on_city_id"
  ...
  add_foreign_key "chatrooms", "cities"
  add_foreign_key "chatrooms", "festivals"
  add_foreign_key "favorites", "festivals"
  add_foreign_key "favorites", "users"
  add_foreign_key "festivals_artists", "artists"
  add_foreign_key "festivals_artists", "festivals"
